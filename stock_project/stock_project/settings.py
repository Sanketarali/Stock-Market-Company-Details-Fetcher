...
SECRET_KEY = 'django-insecure-lw!k=k&!!fgd&ismpaa6q^c@qk(=fa44+*%1l4rmxrm0re9^_a'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # Required for admin sidebar navigation
